...
/**
 * The boundaries class defines storage of the boundaries
 * of a track
 * 
...
public class Boundaries {
	...
	/**
	 * Returns the backing ArrayList of Lines
	 * 
	 * @return ArrayList of Lines (bounds)
	 */
	...
	/**
	 * Returns the finish line of the track
	 * 
	 ...
	 * 
	 * @param trackNumber The track number chosen in InputMain
	 */
	public void createBoundaries(int trackNumber){
